    ...
    <div class="footerFixed">
        <header>
            ...
            <div class="header-wrapper2">
                ...
                <a href="favoritestores" class="store-favorite">お気に入り</a>
            </div>
        </header>
        <main>
            <div class="wrapper">
                            ...
                            <div class="signup-right">
                                ...
                                <div class="signup-info-group">
                                    ...
                                    <div class="signup-info">
                                        <input id="birth" type="date" class="form-control @error('birth') is-invalid @enderror" name="birth" value="{{ old('birth') }}" required autocomplete="birth" autofocus readonly>
                                ...
                                <div class="signup-info-group">
                                    ...
                                    <div class="signup-info">
                                        {{-- 保留 --}}
                                        <input id="sex" type="text" class="form-control @error('sex') is-invalid @enderror" name="sex" value="{{ old('sex') }}" required autocomplete="sex" autofocus readonly>
